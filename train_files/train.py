...
for epoch in range(num_epochs):
    ...
    if test_acc > best_test_acc:
        ...
        patience_counter = 0
        torch.save(model.state_dict(), r'C:\Users\paill\Coding\Projects_for_resume\Emotion_Detection\best_model.pth')
    else:
        patience_counter += 1
    ...
    if patience_counter > patience:
        print("Stopping early due to lack of improvement in test accuracy.")
        break
...
df.to_csv('Accuracies_losses.csv', index=False)
print("Results saved to 'Accuracies_losses.csv'")
